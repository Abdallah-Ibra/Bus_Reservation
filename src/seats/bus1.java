...
public class bus1 {
    ...
    public static ArrayList<bus1> seatInfo = new ArrayList<bus1>();
    public static double bill = 50;
    ...
    private bus1(String name, Object clone) {
    }
    ...
    public void displaySAvaliableSeats() {
        System.out.println(" 1. Gaza CITY       |||    50 Dollar      |||     " + numOfSeat + " Seats    ||| 08:00 -  10:00     ||| Al-Remal");

    }

    public void displayStutofSeat() {
        System.out.println("\n** The available seats for Gaza City Trip: \n");
    ...
    public void reserveSeat() {
        try {
            ...
            while (i <= numSeatForReserved) {
                System.out.print("Enter The number of required seat: ");
   ...
   seatInfo.add(new bus1(Customer.name,arrayReserve.clone()));
    }
    public void deldtReversevation() {
        try {
           ...
           seatInfo.remove(new bus1(Customer.name,arrayReserve.clone()));
    }
    ...
    public static void setNumSeatForReserved(int numSeatForReserved) {
        bus1.numSeatForReserved = numSeatForReserved;
    }
    ...
    public static void setNumSeatForDelete(int numSeatForDelete) {
        bus1.numSeatForDelete = numSeatForDelete;
    }
    ...
    public static void setArrayReserve(ArrayList<String> arrayReserve) {
        bus1.arrayReserve = arrayReserve;
    }
