...
public class bus3 {
    ...
    public static ArrayList<bus3>seatInfo = new ArrayList<bus3>();
    public static double bill = 75;
    ...
    private bus3(String name, Object clone) {
    }
    ...
    public void displaySAvaliableSeats() {
        System.out.println(" 3. Rafah CITY      |||    75 Dollar      |||     " + numOfSeat + " Seats    ||| 11:30 - 12:00      ||| TalAlsoltan");
    }

    public void displayStutofSeat() {
        System.out.println("\n** The available seats for Rafah City Trip: \n");
    ...
    public void reserveSeat() {
        try {
           ...
           seatInfo.add(new bus3(Customer.name,arrayReserve.clone()));
    ...
    public void deldtReversevation() {
        ...
        seatInfo.remove(new bus3(Customer.name,arrayReserve.clone()));
    }
    public void Billing() {
